...
export class CommentsService {
  ...
  async createCommentByPostId(dto: CreateCommentServiceDto) {
    const user: UserDocument | null = await this.usersRepository.findOrNotFoundFail(dto.userId)
    ...
    const comment: CommentDocument = this.CommentModel.createInstance(CreateCommentDto)
